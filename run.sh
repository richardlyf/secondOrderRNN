...
if [ "$1" = "parens_m4" ]; then
    ...
    CUDA_VISIBLE_DEVICES=0 python3 run.py --model mLSTM --train-path=./data/penn/train.txt --valid-path=./data/penn/valid.txt --hidden-size 30 --embedding-size 12 --batch-size 1 --dropout 0 --lr 1e-4 --log penn --log-every 10 
else
